...
wget https://github.com/smallstep/certificates/releases/download/v${CA_VER}/step-ca_${CA_VER}_amd64.deb https://github.com/smallstep/cli/releases/download/v${CLI_VER}/step-cli_${CLI_VER}_amd64.deb
